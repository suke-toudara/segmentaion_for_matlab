...
% 
% if (a==1)
%     color_image = imread('June-02-2022-11-10-33-color.png');
%     color_image=rot90(color_image);
%     color_image=imresize(color_image ,[960 540]);
%     depth_image = imread('June-02-2022-11-10-33-depth.png');
%     depth_image=rot90(depth_image);
%     depth_image=imresize(depth_image ,[960 540]);
%     figure
%     imshow(color_image)
% else 
%     color_image = imread('June-02-2022-11-10-33-color.png');
%     color_image=imresize(color_image ,[540 960]);
%     depth_image = imread('June-02-2022-11-10-33-depth.png');
%     depth_image=imresize(depth_image ,[540 960]);
%     figure
%     imshow(color_image)
% end
% 
% 
% C = semanticseg(color_image, net);
